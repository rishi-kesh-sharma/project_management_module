      ...
      <div className="w-5/12 flex flex-col justify-center items-center">
        <div className="min-w-[380px] flex flex-col space-y-2">
          ...
          <div className="flex justify-end">
            <p className="underline text-slate-500 text-sm ...">Forget Password</p>
          </div>
          <Button />
          ...
          <div style={{ border: "1px solid #0E84ED", padding: "9px", borderRadius: "6px", boxShadow: "0px 0px 12px rgba(0, 0, 0, 0.1)", display: "flex", justifyContent: "center", gap: "12px" }}>
            <svg width="23" height="24" viewBox="0 0 23 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path fill-rule="evenodd" clip-rule="evenodd" d="M11.5 23.4998C14.605 23.4998 17.2081 22.47 19.1109 20.7137L15.3943 17.8282C14.3645 18.5182 13.0472 18.9259 11.5 18.9259C8.50474 18.9259 5.96951 16.903 5.06519 14.1848H1.22314V17.1644C3.11542 20.9228 7.00451 23.4998 11.5 23.4998Z" fill="#34A853" />
              ...
              <path fill-rule="evenodd" clip-rule="evenodd" d="M11.5 5.07386C13.1884 5.07386 14.7043 5.65409 15.8961 6.79364L19.1945 3.49523C17.2029 1.63955 14.5997 0.5 11.5 0.5C7.00451 0.5 3.11542 3.07705 1.22314 6.83545L5.06519 9.815C5.96951 7.09682 8.50474 5.07386 11.5 5.07386Z" fill="#EA4335" />
            </svg>

            Sign In with Google
          </div>
          <div className="w-5/12 flex flex-row justify-center items-center space-y-4" style={{ width: "100%" }}>Don't have an account ? &nbsp;
