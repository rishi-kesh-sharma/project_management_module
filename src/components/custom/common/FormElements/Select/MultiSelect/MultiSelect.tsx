...
>(({ className, ...props }, ref) => {
  ...
  return (
    <CommandPrimitive.Input
      ...
      className={cn(
        "ml-2 bg-transparent outline-none placeholder:text-muted-foreground text-sm flex-1 focus:ring-primary",
        className,
...
>(({ className, value, children, ...props }, ref) => {
  ...
  return (
    <CommandItem
      ...
      className={cn(
        "rounded cursor-pointer px-2 py-3 transition-colors flex justify-between ",
        className,
