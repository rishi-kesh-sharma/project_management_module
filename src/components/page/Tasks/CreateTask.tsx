...
const CreateSubTask: React.FC = () => {
  ...
  const formSchema = z.object({
    subTaskName: z.string().min(2).max(100),
    ...
    subTaskDescription: z.string().min(10).max(1000),
    tags: z.array(
      z.object({
        id: z.string(),
        text: z.string(),
  ...
  return (
    <ShadForm {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        <h1 className="text-bold text-xl mt-[2rem]">Create a SubTask</h1>
        <FormField
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>SubTask Type</FormLabel>
              <FormControl>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>SubTask Budget</FormLabel>
              <FormControl>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>SubTask Tags</FormLabel>
              <FormControl>
                <TagInput
                  {...field}
